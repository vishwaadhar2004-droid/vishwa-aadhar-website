...
// Icons for Social Media and others
...
export const WhatsAppIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2.13 22l5.25-1.38c1.45.79 3.08 1.21 4.66 1.21h.01c5.45 0 9.91-4.46 9.91-9.92 0-2.65-1.03-5.13-2.9-7a9.85 9.85 0 0 0-7.02-2.91zm0 18.23c-1.48 0-2.93-.4-4.19-1.15l-.3-.18-3.12.82.83-3.04-.2-.31a8.216 8.216 0 0 1-1.26-4.38c0-4.54 3.7-8.24 8.24-8.24 2.2 0 4.27.86 5.8 2.42a8.18 8.18 0 0 1 2.41 5.83c.02 4.54-3.68 8.23-8.21 8.23zm4.75-6.5c-.26-.13-1.53-.76-1.77-.85-.23-.09-.4-.13-.57.13-.17.26-.66.85-.81 1.02-.15.17-.3.19-.57.06-.26-.13-1.1-.41-2.1-1.31-.77-.69-1.29-1.54-1.44-1.8-.15-.26-.02-.4.12-.53.11-.11.26-.3.39-.45.13-.15.17-.26.26-.43.09-.17.04-.32-.02-.45-.06-.13-.57-1.37-.78-1.88-.2-.5-.41-.43-.56-.43h-.48c-.17 0-.44.06-.67.31-.23.26-.87.85-.87 2.08 0 1.23.89 2.42 1.02 2.59.13.17 1.76 2.68 4.25 3.76.59.26 1.05.41 1.41.53.59.19 1.13.16 1.56.1.47-.07 1.53-.63 1.74-1.23.21-.6.21-1.11.15-1.23-.06-.12-.23-.19-.49-.32z" />
    </svg>
);
...
export const CircularIcon = () => (
    <svg className="w-12 h-12 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h5M20 20v-5h-5M4 12a8 8 0 018-8v0a8 8 0 018 8v0a8 8 0 01-8 8v0a8 8 0 01-8-8z" />
    </svg>
);
export const MonetizationIcon = () => (
    <svg className="w-12 h-12 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 10v-1m0-8a9 9 0 100 8 9 9 0 000-8z" />
    </svg>
);
